...
namespace gd {
	...
	public:
		...
		GameObject* unk59C;
		PAD(8);
		GJRobotSprite* m_pRobot;
		GJSpiderSprite* m_pSpider;
		bool unk5B0;
		...
		virtual void setColor(cocos2d::_ccColor3B const& a) {
			return reinterpret_cast<void(__thiscall*)(PlayerObject*, cocos2d::_ccColor3B const&)>(
				base + 0x1f77f0
				)(this, a);
		}

		void setSecondColor(cocos2d::_ccColor3B const& a) {
			return reinterpret_cast<void(__thiscall*)(PlayerObject*, cocos2d::_ccColor3B const&)>(
				base + 0x1f7870
				)(this, a);
		}
		...
		void setupStreak() {
			reinterpret_cast<void(__thiscall*)(PlayerObject*)>(base + 0x1e7e90)(this);
		}
